...
import com.webcamconsult.syl.opentok.PublisherControlFragment.PublisherCallbacks;



public class PublisherStatusFragment2 extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        if (!(activity instanceof PublisherControlFragment2.PublisherCallbacks)) {
