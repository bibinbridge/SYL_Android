...
public class UIActivity extends Activity implements Session.SessionListener,
        ...
        PublisherControlFragment.PublisherCallbacks,SYLChangeconferenceListener,Session.ConnectionListener {
...
//sessionid="1_MX40NTIyMjEyMn5-MTQzMDcyMjU1NzMyNn56VVpkSEVGTGU2dzM1bWdpSkJJcUxFbCt-UH4";

//token="T1==";
...
String  connectionid=         session.getConnection().getConnectionId();
  Log.e("connectionid-uiclass",connectionid);      
        if (mPublisher == null) {
    ...
    public void onDisconnected(Session session) {
        Log.i(LOGTAG, "Disconnected to the sessionby sender.");
        Log.e("disconnected to the session-s","disconnected to the session by sender");
    ...
    public void onStreamDropped(Session session, Stream stream) {
      Log.e("onstrean dropped","on stream dropped");
...
Log.e("publisher stream destrotyed", "publisher stream destroyed");
    ...
    private void opentokcalltoFinish()
    {
    	SYLChangeOpentokStatusViewmanager mstatusmanager=new SYLChangeOpentokStatusViewmanager();
...
*/
	...
	public void onConnectionDestroyed(Session arg0, Connection arg1) {
		...
		SYLUtil.buildAlertMessage(UIActivity.this, "Caller cancelled the call");
	}
    @Override
    public void onStreamVideoTypeChanged(Session session, Stream stream,
