...
import com.webcamconsult.syl.opentok.SubscriberControlFragment.SubscriberCallbacks;



public class SubscriberQualityFragment2 extends Fragment {
    ...
    private UIActivity2 openTokActivity;
    ...
    public void onAttach(Activity activity) {
        ...
        openTokActivity = (UIActivity2) activity;
        if (!(activity instanceof SubscriberControlFragment2.SubscriberCallbacks)) {
