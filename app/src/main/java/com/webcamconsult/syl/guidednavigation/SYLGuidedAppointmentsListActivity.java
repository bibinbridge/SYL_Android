 ...
 */
public class SYLGuidedAppointmentsListActivity extends Activity{
...
ImageView mSkipGuidedImageView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.guidedappointmentslist_layout);
        SYLSaveValues.setSylHideguidednavigation("true", SYLGuidedAppointmentsListActivity.this);
