...
public class SYLPhoneContactsAdapter extends BaseAdapter {
	public Activity activity;

	/** The array list tip. */
	ArrayList<SYLPhoneContacts> mSYLPhoneContactsArraylist;
	...
	public SYLPhoneContactsAdapter(Activity listingActivity, int listrowTip,
			ArrayList<SYLPhoneContacts> arrayListTip, Context con) {
	...
	SYLPhoneContacts mSYLPhoneContacts;
	...
	// mImageview=(ImageView)listContentView.findViewById(R.id.img_test);
			...
			txtview_userid.setText(Integer.toString(mSYLPhoneContacts.getId()));
			txtview_mobilenumber.setText(mSYLPhoneContacts.getMobilenumber());
			txtview_email.setText(mSYLPhoneContacts.getEmail());
	...
	String profileimageuri=mSYLPhoneContacts.getProfileimageurl();
...
if(mSYLPhoneContacts.getBitmap()!=null){
	userImageView.setImageBitmap(mSYLPhoneContacts.getBitmap());
}
else {
